...
__attribute__ ((section(".isr_vector"))) const DeviceVectors exception_table =
{
  ...
  (void*) TC0_Handler,           /* 13 Timer Counter Control 0 */
  (void*) TC1_Handler,           /* 14 Timer Counter Control 1 */
  (void*) TC2_Handler,           /* 15 Timer Counter Control 2 */
  (void*) TC3_Handler,            /* 16 Basic Timer Counter 0 */
  (void*) TC4_Handler,            /* 17 Basic Timer Counter 1 */
  (void*) TC5_Handler,            /* 18 Basic Timer Counter 2 */
  (void*) TC6_Handler,            /* 19 Basic Timer Counter 3 */
  (void*) TC7_Handler,            /* 20 Basic Timer Counter 4 */
